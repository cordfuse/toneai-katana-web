// Server-only locale resolver. Reads the toneai_locale cookie via Next's
// headers() API and falls back to the server default (TONEAI_LOCALE env, or
...
export async function resolveLocale(
  ...
  try {
    ...
    const cookieVal = c.get('toneai_locale')?.value
